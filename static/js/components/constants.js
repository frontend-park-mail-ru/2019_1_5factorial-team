...
export const MAP_OF_MODALS = new Map ([
    ['Game multi end', ''],
    ['Game multi leave', ''],
    ['Game training', '<h2 class="text-title modal-window__header">Do you want to start training?</h2><div class="inline"><button class="btn btn_inlined modal-window__btn js-skip-training">No</button><button class="btn btn_contained modal-window__btn js-start-training">Yes</button></div>'],
    ['Game single end', ''],
    ['Game single pause', ''],
    ['Game single leave', ''],
